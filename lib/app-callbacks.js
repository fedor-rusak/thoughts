...
const lineListener = function (currentBackend, appState, line) {
	...
	if (mode === "command") {
		...
		if (normalized === 'clear') {
			...
			currentBackend.dataLayer.writeFile(dataFilePath, JSON.stringify(appState.records, null, 4), handleWriteFile);
		}
			...
			currentBackend.dataLayer.readFile(dataFilePath, handleReadFile);
		}
